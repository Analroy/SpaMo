...
def get_iterator(args, mode, save_path=None, postfix=''):
    ...
    def iterate():
        for i in range(num):
            ...
            if save_path is not None:
                out_file = osp.join(save_path, f'{file_id}{postfix}.npy')
...
'''
python scripts/vit_extract_feature_con.py     --anno_root ./preprocess/How2Sign     --model_name openai/clip-vit-large-patch14     --video_root /scratch/DKS/PhD/Analroyc/Data/    --cache_dir ./chace_dir     --save_dir ../spacial_feature     --s2_mode s2wrapping     --scales 1 2     --batch_size 32     --device cuda:0
